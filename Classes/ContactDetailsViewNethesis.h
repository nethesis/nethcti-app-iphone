...
@interface ContactDetailsViewNethesis : TPMultiLayoutViewController <UICompositeViewDelegate, ImagePickerDelegate> {
	BOOL inhibUpdate;
}

@property(nonatomic, assign, setter=setContact:) Contact *contact;
@property(nonatomic) Contact *tmpContact;
@property(nonatomic, strong) IBOutlet ContactDetailsTableViewNethesis *tableController;
