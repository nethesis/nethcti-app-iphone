...
@objc class VFSUtil: NSObject {
	...
	@objc static let keyChainSharingGroup = "it.nethesis.nethcti3" // Enable Keychain Sharing capabilities in app and all app extensions that need to activate VFS and set key chain group to be the bundle ID for all and here
